...
import time
import json
from zqdk.items import GetMatchAnalysisNumber
class GetMatchAnalysisNumber(scrapy.Spider):
    name = 'getmatchanalysisnumber'
    ...
    def parse(self, response):
        result = json.loads(response.text)
        awayStanding = result["awayStanding"]
        homeStanding = result["awayNearStatus"]
        for awayMatchList in awayStanding:
